...
def fast_actions(filename):
    ...
    alex_polynomial(straighten(np.array(map_labels_to_consecutive_integers(examine_crossings(
        extract_centerlines_for_labels(unify_non_line_segments(labels, classify_segments(separate_labels(labels))))[
        1:-1, 1:-1]))[0])))
    pass
